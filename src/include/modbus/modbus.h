...
//数据存储 对象
// typedef struct IEC104_mapping {
//     int single_yx_bits;
//     int single_yx_start_bits;
//     int double_yx_bits;
//     int double_yx_start_bits;
//     int yc_bytes;
//     int yc_start_bytes;
...
MODBUS_API int modbus_reply(modbus_t *ctx, const uint8_t *req, int req_length, modbus_mapping_t *mb_mapping, double *resvalues);

MODBUS_API int modbus_reply_exception(modbus_t *ctx, const uint8_t *req, unsigned int exception_code);

MODBUS_API void int_to_string(int num, char   ret[]);
