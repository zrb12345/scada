...
int modbus_reply(modbus_t *ctx, const uint8_t *req,
                 int req_length, modbus_mapping_t *mb_mapping,double* resvalue)
{
    int offset;
    int slave;
    int function;
    ...
    case MODBUS_FC_READ_INPUT_REGISTERS: {
        ...
        break;
    case MODBUS_FC_WRITE_SINGLE_COIL: {//写入单个线圈，01 char型
        ...
        break;
    case MODBUS_FC_WRITE_SINGLE_REGISTER: {//写入单个寄存器，03 short型
    ...
    case MODBUS_FC_WRITE_AND_READ_REGISTERS: {
        ...
        if (nb_write < 1 || MODBUS_MAX_WR_WRITE_REGISTERS < nb_write ||
            ...
            // char  str1[]=" slave_id: ";
            // char str2[20];
            // int_to_string(slave,str2);
            // char  str3[]=" address: ";
            // char str4[20];
            // int_to_string(address,str4);
            // char  str5[]=" value: ";
            // char str6[20];
            // int_to_string(nb,str6);
            // printf("Concatenated string: %s\n", str1);
            // if((fp=fopen("writeModbusLog.txt","a"))==NULL)
            // {
            //     printf("无法创建文件！");
            //     exit(0);
            // }
...
#endif
void int_to_string(int num, char raw[] )
{
    char ret[20] = {0};
    char *p = ret;
    do
